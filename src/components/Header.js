...
const Header = () => {
  return (
    <div className='pa2'>
     ...
     <div class="bg-white black-80 tc pv4 avenir">
 
  <h1 class="mt2 mb0 baskerville i fw1 f1">Lotto scratch-off ticket</h1>
  <h2 class="mt2 mb0 f6 fw4 ttu tracked">Let's find the best ticket to buy today</h2>
